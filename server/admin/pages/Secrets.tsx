                ...
                {secrets.map((secret) => (
                  <tr key={secret.id}>
                    ...
                    <td className="action-buttons-cell">
                      <button className="action-button config" onClick={() => openEditModal(secret)} title="Edit Secret">
                        <span className="button-text">Edit</span>
                      </button>
                      <button className="action-button release" onClick={() => handleDelete(secret)} title="Delete Secret">
